...
\end{center}
	...
	\item 
	一辆1998年的雷克萨斯LS400车的阻力系数为0.28,参考面积为2.4$m^2$.求当运行速度为70 m/h时 分别在(1)37.8$^\circ\mathrm{C}$的夏季(2)及-17.8$^\circ\mathrm{C}$的严冬的功率
	
	\item
	棒球的周长为23.495 cm,重149 g,在95m/h的速度下求：(1)雷诺数.(2)阻力(参考面积为球的主截面)(3)流动类型
	\begin{center}
