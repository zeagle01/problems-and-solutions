...
\begin{enumerate}
	...
	\item Figure below shows the position of an element with sides parallel to the coordinate axes at time t, and its subsequent position at t+dt. express the strain rate $((dα+dβ)/dt)$  with $u_1,u_2,x_1,x_2$
	\begin{center}
